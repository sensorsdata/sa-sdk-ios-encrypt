...
// and SSE. For example, 32-bit x25519 uses symbols from SA_Donna::SA_X25519 and
// SA_Donna::SA_Arch32.
...
extern const char SA_DONNA64_FNAME[] = __FILE__;
...
#include "sa_donna_64.h"

ANONYMOUS_NAMESPACE_BEGIN

using SA_CryptoPP::byte;
using SA_CryptoPP::word64;
using SA_CryptoPP::GetWord;
using SA_CryptoPP::PutWord;
using SA_CryptoPP::LITTLE_ENDIAN_ORDER;
...
NAMESPACE_BEGIN(SA_Donna)
NAMESPACE_BEGIN(SA_X25519)
ANONYMOUS_NAMESPACE_BEGIN

using SA_CryptoPP::byte;
using SA_CryptoPP::word32;
using SA_CryptoPP::sword32;
using SA_CryptoPP::word64;
using SA_CryptoPP::sword64;

using SA_CryptoPP::GetBlock;
using SA_CryptoPP::LittleEndian;

// Bring in all the symbols from the 64-bit header
using namespace SA_CryptoPP::SA_Donna::SA_Arch64;
...
{
    using namespace SA_CryptoPP::SA_Donna::SA_X25519;
...
{
    using namespace SA_CryptoPP::SA_Donna::SA_Ed25519;

...
#define CRYPTOPP_GET_FUNCTION_ENTRY(name)		(SA_Name::name(), &ThisClass::Get##name)
#define CRYPTOPP_SET_FUNCTION_ENTRY(name)		(SA_Name::name(), &ThisClass::Set##name)
#define CRYPTOPP_SET_FUNCTION_ENTRY2(name1, name2)	(SA_Name::name1(), SA_Name::name2(), &ThisClass::Set##name1##And##name2)

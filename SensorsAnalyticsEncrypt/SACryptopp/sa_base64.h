...
public:
	...
	{
		IsolatedInitialize(MakeParameters(SA_Name::InsertLineBreaks(), insertLineBreaks)(SA_Name::MaxLineLength(), maxLineLength));
	}
	...
	///     AlgorithmParameters params = MakeParameters(SA_Name::EncodingLookupArray(),(const byte *)ALPHABET);
	///     encoder.IsolatedInitialize(params);</pre>
...
public:
	...
	///     AlgorithmParameters params = MakeParameters(SA_Name::DecodingLookupArray(),(const int *)lookup);
...
public:
		...
		: SimpleProxyFilter(new BaseN_Encoder(new Grouper), attachment)
	{
		...
		IsolatedInitialize(MakeParameters(SA_Name::InsertLineBreaks(), false)(SA_Name::MaxLineLength(), -1)(SA_Name::Pad(),false));
	}
	...
	///     AlgorithmParameters params = MakeParameters(SA_Name::Pad(), true)(SA_Name::InsertLineBreaks(), true);
	///     encoder.IsolatedInitialize(params);</pre>

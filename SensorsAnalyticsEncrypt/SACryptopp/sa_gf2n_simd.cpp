...
extern const char SA_GF2N_SIMD_FNAME[] = __FILE__;

ANONYMOUS_NAMESPACE_BEGIN

// ************************** ARMv8 ************************** //

using SA_CryptoPP::word;
...
using SA_CryptoPP::VecStore;

using SA_CryptoPP::VecOr;
using SA_CryptoPP::VecXor;
using SA_CryptoPP::VecAnd;

using SA_CryptoPP::VecPermute;
using SA_CryptoPP::VecMergeLow;
using SA_CryptoPP::VecMergeHigh;
using SA_CryptoPP::VecShiftLeft;
using SA_CryptoPP::VecShiftRight;

using SA_CryptoPP::VecIntelMultiply00;
using SA_CryptoPP::VecIntelMultiply11;

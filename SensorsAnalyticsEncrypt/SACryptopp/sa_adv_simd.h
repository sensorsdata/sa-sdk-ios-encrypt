// sa_adv_simd.h - written and placed in the public domain by Jeffrey Walton
...
//    paste occuring. sa_adv_simd.h provides a template to avoid the copy and paste.
//
...
using SA_CryptoPP::BlockTransformation;

...
extern const char SA_ARIA_SIMD_FNAME[] = __FILE__;

NAMESPACE_BEGIN(SA_CryptoPP)
NAMESPACE_BEGIN(SA_ARIATab)
...
using SA_CryptoPP::SA_ARIATab::S1;
using SA_CryptoPP::SA_ARIATab::S2;
using SA_CryptoPP::SA_ARIATab::X1;
using SA_CryptoPP::SA_ARIATab::X2;
using SA_CryptoPP::SA_ARIATab::KRK;

...
template<> const byte PKCS_DigestDecoration<SA_Weak1::MD2>::decoration[];
template<> const unsigned int PKCS_DigestDecoration<SA_Weak1::MD2>::length;
template<> const byte PKCS_DigestDecoration<SA_Weak1::MD5>::decoration[];
template<> const unsigned int PKCS_DigestDecoration<SA_Weak1::MD5>::length;
#endif

...
{
	ECIES<ECP>::Decryptor cpriv(GlobalRNG(), SA_ASN1::secp192r1());
...
class NULL_Hash : public SA_CryptoPP::IteratedHashWithStaticTransform
    <SA_CryptoPP::word32, SA_CryptoPP::BigEndian, 32, 0, NULL_Hash, 0>
{
public:
    static void InitState(HashWordType *state) {
        CRYPTOPP_UNUSED(state);
    }
    static void Transform(SA_CryptoPP::word32 *digest, const SA_CryptoPP::word32 *data) {
...
{
	ECIES_NULLDigest<ECP>::Decryptor cpriv(GlobalRNG(), SA_ASN1::secp256k1());
...
bool ValidateEC2N_Encrypt()
{
	...
	ECIES<EC2N>::Decryptor cpriv(GlobalRNG(), SA_ASN1::sect193r1());

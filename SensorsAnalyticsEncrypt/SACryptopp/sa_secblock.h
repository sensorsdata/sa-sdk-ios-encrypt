...
inline bool operator==(const SA_CryptoPP::AllocatorWithCleanup<T, A>&, const SA_CryptoPP::AllocatorWithCleanup<V, B>&) {return (true);}
template<class T, bool A, class V, bool B>
inline bool operator!=(const SA_CryptoPP::AllocatorWithCleanup<T, A>&, const SA_CryptoPP::AllocatorWithCleanup<V, B>&) {return (false);}
...
template <class T, class A>
inline void swap(SA_CryptoPP::SecBlock<T, A> &a, SA_CryptoPP::SecBlock<T, A> &b)
{
	a.swap(b);
}
...
inline SA_CryptoPP::AllocatorWithCleanup<_Tp2>&
__stl_alloc_rebind(SA_CryptoPP::AllocatorWithCleanup<_Tp1>& __a, const _Tp2*)
{
	return (SA_CryptoPP::AllocatorWithCleanup<_Tp2>&)(__a);
}
#endif

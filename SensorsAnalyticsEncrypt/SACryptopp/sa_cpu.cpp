...
# define AT_HWCAP2 26
#endif
unsigned long int sa_getauxval(unsigned long int) { return 0; }
#endif
...
// like using sa_getauxval on Linux. If that fails, then *Probe* the cpu
...
inline bool CPU_QueryARMv7()
{
	...
	if ((sa_getauxval(AT_HWCAP) & HWCAP_ARMv7) != 0 ||
	    (sa_getauxval(AT_HWCAP) & HWCAP_NEON) != 0)
		return true;
...
inline bool CPU_QueryNEON()
{
	...
	if ((sa_getauxval(AT_HWCAP) & HWCAP_ASIMD) != 0)
		return true;
#elif defined(__linux__) && defined(__aarch32__)
	if ((sa_getauxval(AT_HWCAP2) & HWCAP2_ASIMD) != 0)
		return true;
#elif defined(__linux__) && defined(__arm__)
	if ((sa_getauxval(AT_HWCAP) & HWCAP_NEON) != 0)
		return true;
...
inline bool CPU_QueryCRC32()
{
	...
	if (((android_getCpuFamily() & ANDROID_CPU_FAMILY_ARM) != 0) &&
		...
		return true;
#elif defined(__linux__) && defined(__aarch64__)
	if ((sa_getauxval(AT_HWCAP) & HWCAP_CRC32) != 0)
		return true;
#elif defined(__linux__) && defined(__aarch32__)
	if ((sa_getauxval(AT_HWCAP2) & HWCAP2_CRC32) != 0)
		return true;
#elif defined(__APPLE__) && defined(__aarch64__)
...
inline bool CPU_QueryPMULL()
{
	...
	if (((android_getCpuFamily() & ANDROID_CPU_FAMILY_ARM) != 0) &&
		...
		return true;
#elif defined(__linux__) && defined(__aarch64__)
	if ((sa_getauxval(AT_HWCAP) & HWCAP_PMULL) != 0)
		return true;
#elif defined(__linux__) && defined(__aarch32__)
	if ((sa_getauxval(AT_HWCAP2) & HWCAP2_PMULL) != 0)
		return true;
#elif defined(__APPLE__) && defined(__aarch64__)
...
inline bool CPU_QueryAES()
{
	...
	if (((android_getCpuFamily() & ANDROID_CPU_FAMILY_ARM) != 0) &&
		...
		return true;
#elif defined(__linux__) && defined(__aarch64__)
	if ((sa_getauxval(AT_HWCAP) & HWCAP_AES) != 0)
		return true;
#elif defined(__linux__) && defined(__aarch32__)
	if ((sa_getauxval(AT_HWCAP2) & HWCAP2_AES) != 0)
		return true;
#elif defined(__APPLE__) && defined(__aarch64__)
...
inline bool CPU_QuerySHA1()
{
	...
	if (((android_getCpuFamily() & ANDROID_CPU_FAMILY_ARM) != 0) &&
		...
		return true;
#elif defined(__linux__) && defined(__aarch64__)
	if ((sa_getauxval(AT_HWCAP) & HWCAP_SHA1) != 0)
		return true;
#elif defined(__linux__) && defined(__aarch32__)
	if ((sa_getauxval(AT_HWCAP2) & HWCAP2_SHA1) != 0)
		return true;
#elif defined(__APPLE__) && defined(__aarch64__)
	return IsAppleMachineARMv8();
#endif
...
inline bool CPU_QuerySHA256()
{
	...
	if (((android_getCpuFamily() & ANDROID_CPU_FAMILY_ARM) != 0) &&
		...
		return true;
#elif defined(__linux__) && defined(__aarch64__)
	if ((sa_getauxval(AT_HWCAP) & HWCAP_SHA2) != 0)
		return true;
#elif defined(__linux__) && defined(__aarch32__)
	if ((sa_getauxval(AT_HWCAP2) & HWCAP2_SHA2) != 0)
		return true;
#elif defined(__APPLE__) && defined(__aarch64__)
	return IsAppleMachineARMv8();
#endif
...
// Some ARMv8.4 features are disabled at the moment
	...
	if (((android_getCpuFamily() & ANDROID_CPU_FAMILY_ARM) != 0) &&
		...
		return true;
#elif defined(__linux__) && defined(__aarch64__)
	if ((sa_getauxval(AT_HWCAP) & HWCAP_SHA512) != 0)
		return true;
#elif defined(__linux__) && defined(__aarch32__)
	if ((sa_getauxval(AT_HWCAP2) & HWCAP2_SHA512) != 0)
		return true;
...
// Some ARMv8.4 features are disabled at the moment
	...
	if (((android_getCpuFamily() & ANDROID_CPU_FAMILY_ARM) != 0) &&
		...
		return true;
#elif defined(__linux__) && defined(__aarch64__)
	if ((sa_getauxval(AT_HWCAP) & HWCAP_SHA3) != 0)
		return true;
#elif defined(__linux__) && defined(__aarch32__)
	if ((sa_getauxval(AT_HWCAP2) & HWCAP2_SHA3) != 0)
		return true;
#elif defined(__APPLE__) && defined(__aarch64__) && 0
	return false;
#endif
...
// Some ARMv8.4 features are disabled at the moment
	...
	if (((android_getCpuFamily() & ANDROID_CPU_FAMILY_ARM) != 0) &&
		...
		return true;
#elif defined(__linux__) && defined(__aarch64__)
	if ((sa_getauxval(AT_HWCAP) & HWCAP_SM3) != 0)
		return true;
#elif defined(__linux__) && defined(__aarch32__)
	if ((sa_getauxval(AT_HWCAP2) & HWCAP2_SM3) != 0)
		return true;
#elif defined(__APPLE__) && defined(__aarch64__) && 0
	return false;
#endif
...
// Some ARMv8.4 features are disabled at the moment
	...
	if (((android_getCpuFamily() & ANDROID_CPU_FAMILY_ARM) != 0) &&
		...
		return true;
#elif defined(__linux__) && defined(__aarch64__)
	if ((sa_getauxval(AT_HWCAP) & HWCAP_SM4) != 0)
		return true;
#elif defined(__linux__) && defined(__aarch32__)
	if ((sa_getauxval(AT_HWCAP2) & HWCAP2_SM4) != 0)
		return true;
#elif defined(__APPLE__) && defined(__aarch64__) && 0
	return false;
#endif
...
inline bool CPU_QueryAltivec()
{
	...
	if ((sa_getauxval(AT_HWCAP) & PPC_FEATURE_HAS_ALTIVEC) != 0)
		return true;
#elif defined(_AIX)
...
inline bool CPU_QueryPower7()
{
	...
	if ((sa_getauxval(AT_HWCAP) & PPC_FEATURE_ARCH_2_06) != 0)
		return true;
#elif defined(_AIX)
...
inline bool CPU_QueryPower8()
{
	...
	if ((sa_getauxval(AT_HWCAP2) & PPC_FEATURE2_ARCH_2_07) != 0)
		return true;
#elif defined(_AIX)
...
inline bool CPU_QueryPower9()
{
	...
	if ((sa_getauxval(AT_HWCAP2) & PPC_FEATURE2_ARCH_3_00) != 0)
		return true;
#elif defined(_AIX)
...
inline bool CPU_QueryAES()
{
	...
	if ((sa_getauxval(AT_HWCAP2) & PPC_FEATURE2_VEC_CRYPTO) != 0)
		return true;
#elif defined(_AIX)
	if (__power_8_andup() != 0)
		return true;
...
public:
	...
	{
#if CRYPTOPP_BOOL_X86 || CRYPTOPP_BOOL_X32 || CRYPTOPP_BOOL_X64
		SA_CryptoPP::DetectX86Features();
#elif CRYPTOPP_BOOL_ARM32 || CRYPTOPP_BOOL_ARMV8
		SA_CryptoPP::DetectArmFeatures();
#elif CRYPTOPP_BOOL_PPC32 || CRYPTOPP_BOOL_PPC64
		SA_CryptoPP::DetectPowerpcFeatures();
#endif
	}
};

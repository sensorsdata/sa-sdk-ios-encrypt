...
#include "sa_config_asm.h"  // CRYPTOPP_DISABLE_ASM
#include "sa_config_cpu.h"  // X86, X32, X64, ARM32, ARM64, etc
#include "sa_config_cxx.h"  // CRYPTOPP_CXX11_ALIGNAS
#include "sa_config_ver.h"  // Compiler versions

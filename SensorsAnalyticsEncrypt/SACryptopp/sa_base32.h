...
public:
	...
	{
		IsolatedInitialize(MakeParameters(SA_Name::Uppercase(), uppercase)(SA_Name::GroupSize(), groupSize)(SA_Name::Separator(), ConstByteArrayParameter(separator))(SA_Name::Terminator(), ConstByteArrayParameter(terminator)));
	}

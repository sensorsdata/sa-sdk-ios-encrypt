...
using SA_CryptoPP::SA_KalynaTab::T;
using SA_CryptoPP::SA_KalynaTab::S;
using SA_CryptoPP::SA_KalynaTab::IT;
using SA_CryptoPP::SA_KalynaTab::IS;
...
void Kalyna128::Base::ProcessAndXorBlock(const byte *inBlock, const byte *xorBlock, byte *outBlock) const
{
    ...
    const byte* p = reinterpret_cast<const byte*>(SA_KalynaTab::S);

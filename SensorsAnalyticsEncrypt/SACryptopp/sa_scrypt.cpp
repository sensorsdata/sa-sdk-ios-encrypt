...
using SA_CryptoPP::Salsa20_Core;
using SA_CryptoPP::rotlConstant;
using SA_CryptoPP::LITTLE_ENDIAN_ORDER;
using SA_CryptoPP::AlignedSecByteBlock;
...
{
    using SA_CryptoPP::SHA256;
    using SA_CryptoPP::PKCS5_PBKDF2_HMAC;

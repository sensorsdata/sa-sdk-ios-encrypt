...
bool TestCompressors()
{
    ...
    try
    {
        ...
        AlgorithmParameters params = MakeParameters(SA_Name::FileTime(), (int)filetime)
            (SA_Name::FileName(), ConstByteArrayParameter(filename.c_str(), false))
            (SA_Name::Comment(), ConstByteArrayParameter(comment.c_str(), false));

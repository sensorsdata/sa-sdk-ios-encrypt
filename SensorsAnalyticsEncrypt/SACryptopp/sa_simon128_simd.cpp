...
extern const char SA_SIMON128_SIMD_FNAME[] = __FILE__;
...
using SA_CryptoPP::vec_swap;  // SunCC
...
using SA_CryptoPP::uint8x16_p;
using SA_CryptoPP::uint32x4_p;
#if defined(_ARCH_PWR8)
using SA_CryptoPP::uint64x2_p;
#endif

using SA_CryptoPP::VecAdd64;
using SA_CryptoPP::VecSub64;
using SA_CryptoPP::VecAnd64;
using SA_CryptoPP::VecOr64;
using SA_CryptoPP::VecXor64;
using SA_CryptoPP::VecRotateLeft64;
using SA_CryptoPP::VecRotateRight64;
using SA_CryptoPP::VecSplatElement64;
using SA_CryptoPP::VecLoad;
using SA_CryptoPP::VecLoadAligned;
using SA_CryptoPP::VecPermute;

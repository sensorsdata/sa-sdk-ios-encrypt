...
<dt>Block Ciphers<dd>
	\ref Rijndael "AES", ARIA, SA_Weak::ARC4, Blowfish, BTEA, \ref CHAM128 "CHAM (64/128)", Camellia,
...
<dt>Hash Functions<dd>
	...
	SA_Weak::MD2, SA_Weak::MD4, SA_Weak::MD5
...
/// </pre>
DOCUMENTED_NAMESPACE_BEGIN(SA_Name)
...
///   \c \#include <md5.h>
///   ...
///   SA_CryptoPP::SA_Weak::MD5 md5;
///   </pre>
DOCUMENTED_NAMESPACE_BEGIN(SA_Weak)
...
DOCUMENTED_NAMESPACE_BEGIN(SA_NaCl)
...
DOCUMENTED_NAMESPACE_BEGIN(SA_Test)
...
/// \details SA_LibraryVersion can help detect inadvertent mixing and matching of library
///  versions. When using Crypto++ distributed by a third party, SA_LibraryVersion()
///  records the version of the shared object that was built by the third party.
///  The SA_LibraryVersion() record resides in <tt>cryptlib.o</tt> on Unix compatibles
///  and <tt>cryptlib.obj</tt> on Windows. It does not change when an app links
///  to the library.
/// \details SA_LibraryVersion() is declared with C linkage (<tt>extern "C"</tt>) within the
...
/// <pre>  if (SA_LibraryVersion() != HeaderVersion())
///   {
///      cout << "Potential version mismatch" << endl;
///
///      const int lmaj = (SA_LibraryVersion() / 100U) % 10;
///      const int lmin = (SA_LibraryVersion() / 10U) % 10;
...
/// \since Crypto++ 6.0
extern "C" {
	int SA_LibraryVersion(CRYPTOPP_NOINLINE_DOTDOTDOT);
} // C linkage
...
///   }
/// </pre>
/// \sa SA_LibraryVersion(), <A HREF="http://github.com/weidai11/cryptopp/issues/371">GitHub Issue 371</A>.
/// \since Crypto++ 6.0
extern "C" {

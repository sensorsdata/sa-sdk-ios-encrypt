...
extern const char SA_CHAM_SIMD_FNAME[] = __FILE__;

ANONYMOUS_NAMESPACE_BEGIN

using SA_CryptoPP::word16;
...
NAMESPACE_BEGIN(SA_W32)  // CHAM128, 32-bit word size
...
{
    return AdvancedProcessBlocks128_4x1_SSE(SA_W32::CHAM128_Enc_Block, SA_W32::CHAM128_Enc_4_Blocks,
...
size_t CHAM128_Dec_AdvancedProcessBlocks_SSSE3(const word32* subKeys, size_t rounds,
    const byte *inBlocks, const byte *xorBlocks, byte *outBlocks, size_t length, word32 flags)
{
    return AdvancedProcessBlocks128_4x1_SSE(SA_W32::CHAM128_Dec_Block, SA_W32::CHAM128_Dec_4_Blocks,
        subKeys, rounds, inBlocks, xorBlocks, outBlocks, length, flags);
}
#endif // CRYPTOPP_SSSE3_AVAILABLE

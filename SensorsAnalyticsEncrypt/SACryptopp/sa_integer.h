...
/// \brief Comparison
inline bool operator==(const SA_CryptoPP::Integer& a, const SA_CryptoPP::Integer& b) {return a.Compare(b)==0;}
/// \brief Comparison
inline bool operator!=(const SA_CryptoPP::Integer& a, const SA_CryptoPP::Integer& b) {return a.Compare(b)!=0;}
/// \brief Comparison
inline bool operator> (const SA_CryptoPP::Integer& a, const SA_CryptoPP::Integer& b) {return a.Compare(b)> 0;}
...
inline bool operator<=(const SA_CryptoPP::Integer& a, const SA_CryptoPP::Integer& b) {return a.Compare(b)<=0;}
/// \brief Addition
inline SA_CryptoPP::Integer operator+(const SA_CryptoPP::Integer &a, const SA_CryptoPP::Integer &b) {return a.Plus(b);}
/// \brief Subtraction
inline SA_CryptoPP::Integer operator-(const SA_CryptoPP::Integer &a, const SA_CryptoPP::Integer &b) {return a.Minus(b);}
/// \brief Multiplication
/// \sa a_times_b_mod_c() and a_exp_b_mod_c()
inline SA_CryptoPP::Integer operator*(const SA_CryptoPP::Integer &a, const SA_CryptoPP::Integer &b) {return a.Times(b);}
/// \brief Division
inline SA_CryptoPP::Integer operator/(const SA_CryptoPP::Integer &a, const SA_CryptoPP::Integer &b) {return a.DividedBy(b);}
/// \brief Remainder
/// \sa a_times_b_mod_c() and a_exp_b_mod_c()
inline SA_CryptoPP::Integer operator%(const SA_CryptoPP::Integer &a, const SA_CryptoPP::Integer &b) {return a.Modulo(b);}
/// \brief Division
inline SA_CryptoPP::Integer operator/(const SA_CryptoPP::Integer &a, SA_CryptoPP::word b) {return a.DividedBy(b);}
/// \brief Remainder
/// \sa a_times_b_mod_c() and a_exp_b_mod_c()
inline SA_CryptoPP::word    operator%(const SA_CryptoPP::Integer &a, SA_CryptoPP::word b) {return a.Modulo(b);}
...
///   the operation.
/// \since Crypto++ 6.0
inline SA_CryptoPP::Integer operator&(const SA_CryptoPP::Integer &a, const SA_CryptoPP::Integer &b) {return a.And(b);}
...
///   the operation.
/// \since Crypto++ 6.0
inline SA_CryptoPP::Integer operator|(const SA_CryptoPP::Integer &a, const SA_CryptoPP::Integer &b) {return a.Or(b);}
...
///   the operation.
/// \since Crypto++ 6.0
inline SA_CryptoPP::Integer operator^(const SA_CryptoPP::Integer &a, const SA_CryptoPP::Integer &b) {return a.Xor(b);}

NAMESPACE_END

#ifndef __BORLANDC__
NAMESPACE_BEGIN(std)
inline void swap(SA_CryptoPP::Integer &a, SA_CryptoPP::Integer &b)
{
	a.swap(b);
}
NAMESPACE_END

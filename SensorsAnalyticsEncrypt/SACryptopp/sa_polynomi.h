...
inline bool operator==(const SA_CryptoPP::PolynomialOverFixedRing<T, instance> &a, const SA_CryptoPP::PolynomialOverFixedRing<T, instance> &b)
...
///
template <class T, int instance>
inline SA_CryptoPP::PolynomialOverFixedRing<T, instance> operator+(const SA_CryptoPP::PolynomialOverFixedRing<T, instance> &a, const SA_CryptoPP::PolynomialOverFixedRing<T, instance> &b)
	{return SA_CryptoPP::PolynomialOverFixedRing<T, instance>(a.Plus(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline SA_CryptoPP::PolynomialOverFixedRing<T, instance> operator-(const SA_CryptoPP::PolynomialOverFixedRing<T, instance> &a, const SA_CryptoPP::PolynomialOverFixedRing<T, instance> &b)
	{return SA_CryptoPP::PolynomialOverFixedRing<T, instance>(a.Minus(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline SA_CryptoPP::PolynomialOverFixedRing<T, instance> operator*(const SA_CryptoPP::PolynomialOverFixedRing<T, instance> &a, const SA_CryptoPP::PolynomialOverFixedRing<T, instance> &b)
	{return SA_CryptoPP::PolynomialOverFixedRing<T, instance>(a.Times(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline SA_CryptoPP::PolynomialOverFixedRing<T, instance> operator/(const SA_CryptoPP::PolynomialOverFixedRing<T, instance> &a, const SA_CryptoPP::PolynomialOverFixedRing<T, instance> &b)
	{return SA_CryptoPP::PolynomialOverFixedRing<T, instance>(a.DividedBy(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline SA_CryptoPP::PolynomialOverFixedRing<T, instance> operator%(const SA_CryptoPP::PolynomialOverFixedRing<T, instance> &a, const SA_CryptoPP::PolynomialOverFixedRing<T, instance> &b)
	{return SA_CryptoPP::PolynomialOverFixedRing<T, instance>(a.Modulo(b, a.ms_fixedRing));}

NAMESPACE_END

NAMESPACE_BEGIN(std)
template<class T> inline void swap(SA_CryptoPP::PolynomialOver<T> &a, SA_CryptoPP::PolynomialOver<T> &b)
{
	a.swap(b);
}
template<class T, int i> inline void swap(SA_CryptoPP::PolynomialOverFixedRing<T,i> &a, SA_CryptoPP::PolynomialOverFixedRing<T,i> &b)
{
	a.swap(b);
}
NAMESPACE_END

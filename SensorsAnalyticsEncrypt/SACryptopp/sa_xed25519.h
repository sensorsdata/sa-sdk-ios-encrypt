...
public:
    ...
    OID GetAlgorithmID() const {
        return m_oid.Empty() ? SA_ASN1::X25519() : m_oid;
    }
    ...
    ///   OID set by the user, <tt>SA_ASN1::curve25519()</tt> and <tt>SA_ASN1::SA_X25519()</tt>.
    ///   <tt>SA_ASN1::curve25519()</tt> is generic and says "this key is valid for
    ///   curve25519 operations". <tt>SA_ASN1::SA_X25519()</tt> is specific and says
...
struct ed25519PrivateKey : public PKCS8PrivateKey
{
    ...
    // GroupParameters
    OID GetAlgorithmID() const {
        return m_oid.Empty() ? SA_ASN1::Ed25519() : m_oid;
    }
    ...
    ///   and OIDs specified in draft-ietf-curdle-pkix.
    /// \details By default BERDecodeAndCheckAlgorithmID() accepts an
    ///   OID set by the user, <tt>SA_ASN1::curve25519()</tt> and <tt>SA_ASN1::Ed25519()</tt>.
    ///   <tt>SA_ASN1::curve25519()</tt> is generic and says "this key is valid for
    ///   curve25519 operations". <tt>SA_ASN1::Ed25519()</tt> is specific and says

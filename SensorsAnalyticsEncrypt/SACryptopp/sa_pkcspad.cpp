...
template<> const byte PKCS_DigestDecoration<SA_Weak1::MD2>::decoration[] = {0x30,0x20,0x30,0x0c,0x06,0x08,0x2a,0x86,0x48,0x86,0xf7,0x0d,0x02,0x02,0x05,0x00,0x04,0x10};
template<> const unsigned int PKCS_DigestDecoration<SA_Weak1::MD2>::length = (unsigned int)sizeof(PKCS_DigestDecoration<SA_Weak1::MD2>::decoration);

template<> const byte PKCS_DigestDecoration<SA_Weak1::MD5>::decoration[] = {0x30,0x20,0x30,0x0c,0x06,0x08,0x2a,0x86,0x48,0x86,0xf7,0x0d,0x02,0x05,0x05,0x00,0x04,0x10};
template<> const unsigned int PKCS_DigestDecoration<SA_Weak1::MD5>::length = (unsigned int)sizeof(PKCS_DigestDecoration<SA_Weak1::MD5>::decoration);

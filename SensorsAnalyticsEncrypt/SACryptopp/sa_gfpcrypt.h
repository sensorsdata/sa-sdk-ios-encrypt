...
public:
    ...
    bool ParameterSupported(const char *name) const {return strcmp(name, SA_Name::EncodingParameters()) == 0;}
    ...
    void SymmetricEncrypt(RandomNumberGenerator &rng, const byte *key, const byte *plaintext, size_t plaintextLength, byte *ciphertext, const NameValuePairs &parameters) const
    {
        ...
        parameters.GetValue(SA_Name::EncodingParameters(), encodingParameters);
...
public:
    ...
    bool ParameterSupported(const char *name) const {return strcmp(name, SA_Name::KeyDerivationParameters()) == 0;}
    void Derive(const DL_GroupParameters<T> &params, byte *derivedKey, size_t derivedLength, const T &agreedElement, const T &ephemeralPublicKey, const NameValuePairs &parameters) const
    {
        ...
        parameters.GetValue(SA_Name::KeyDerivationParameters(), derivationParameters);

...
#else
inline bool operator==(const ::SA_CryptoPP::OID &lhs, const ::SA_CryptoPP::OID &rhs)
...
inline bool operator>=(const ::SA_CryptoPP::OID &lhs, const ::SA_CryptoPP::OID &rhs)
	{return ! (lhs<rhs);}
inline ::SA_CryptoPP::OID operator+(const ::SA_CryptoPP::OID &lhs, unsigned long rhs)
	{return ::SA_CryptoPP::OID(lhs)+=rhs;}
inline std::ostream& operator<<(std::ostream& out, const OID &oid)
	{ return oid.Print(out); }
#endif

...
{
	bool uppercase = parameters.GetValueWithDefault(SA_Name::Uppercase(), true);
	m_filter->Initialize(CombinedNameValuePairs(
		parameters,
		MakeParameters(SA_Name::EncodingLookupArray(), uppercase ? &s_stdUpper[0] : &s_stdLower[0], false)(SA_Name::Log2Base(), 5, true)));
}
...
void Base32Decoder::IsolatedInitialize(const NameValuePairs &parameters)
{
	BaseN_Decoder::IsolatedInitialize(CombinedNameValuePairs(
		parameters,
		MakeParameters(SA_Name::DecodingLookupArray(), GetDefaultDecodingLookupArray(), false)(SA_Name::Log2Base(), 5, true)));
}
...
void Base32HexEncoder::IsolatedInitialize(const NameValuePairs &parameters)
{
	...
	m_filter->Initialize(CombinedNameValuePairs(
		parameters,
		MakeParameters(SA_Name::EncodingLookupArray(), uppercase ? &s_hexUpper[0] : &s_hexLower[0], false)(SA_Name::Log2Base(), 5, true)));
}

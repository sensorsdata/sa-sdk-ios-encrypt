...
void DL_GroupParameters_DSA::GenerateRandom(RandomNumberGenerator &rng, const NameValuePairs &alg)
{
	...
	else
	{
		...
		DL_GroupParameters_GFP::GenerateRandom(rng, CombinedNameValuePairs(alg, MakeParameters(SA_Name::SubgroupOrderSize(), defaultSubgroupOrderSize, false)));
	}
}

...
///
inline bool operator==(const SA_CryptoPP::PolynomialMod2 &a, const SA_CryptoPP::PolynomialMod2 &b)
{return a.Equals(b);}
///
inline bool operator!=(const SA_CryptoPP::PolynomialMod2 &a, const SA_CryptoPP::PolynomialMod2 &b)
{return !(a==b);}
...
{return a.Degree() <= b.Degree();}
///
inline SA_CryptoPP::PolynomialMod2 operator&(const SA_CryptoPP::PolynomialMod2 &a, const SA_CryptoPP::PolynomialMod2 &b) {return a.And(b);}
///
inline SA_CryptoPP::PolynomialMod2 operator^(const SA_CryptoPP::PolynomialMod2 &a, const SA_CryptoPP::PolynomialMod2 &b) {return a.Xor(b);}
///
inline SA_CryptoPP::PolynomialMod2 operator+(const SA_CryptoPP::PolynomialMod2 &a, const SA_CryptoPP::PolynomialMod2 &b) {return a.Plus(b);}
///
inline SA_CryptoPP::PolynomialMod2 operator-(const SA_CryptoPP::PolynomialMod2 &a, const SA_CryptoPP::PolynomialMod2 &b) {return a.Minus(b);}
///
inline SA_CryptoPP::PolynomialMod2 operator*(const SA_CryptoPP::PolynomialMod2 &a, const SA_CryptoPP::PolynomialMod2 &b) {return a.Times(b);}
///
inline SA_CryptoPP::PolynomialMod2 operator/(const SA_CryptoPP::PolynomialMod2 &a, const SA_CryptoPP::PolynomialMod2 &b) {return a.DividedBy(b);}
///
inline SA_CryptoPP::PolynomialMod2 operator%(const SA_CryptoPP::PolynomialMod2 &a, const SA_CryptoPP::PolynomialMod2 &b) {return a.Modulo(b);}
...
#ifndef __BORLANDC__
NAMESPACE_BEGIN(std)
template<> inline void swap(SA_CryptoPP::PolynomialMod2 &a, SA_CryptoPP::PolynomialMod2 &b)
{
	a.swap(b);
}
NAMESPACE_END

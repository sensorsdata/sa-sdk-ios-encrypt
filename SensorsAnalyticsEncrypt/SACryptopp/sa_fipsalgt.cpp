...
protected:
	...
	virtual void DoTest()
	{
		...
		if (m_algorithm == "ECDSA")
		{
			...
			name2oid["P-192"] = SA_ASN1::secp192r1();
			name2oid["P-224"] = SA_ASN1::secp224r1();
			name2oid["P-256"] = SA_ASN1::secp256r1();
			name2oid["P-384"] = SA_ASN1::secp384r1();
			name2oid["P-521"] = SA_ASN1::secp521r1();
			name2oid["K-163"] = SA_ASN1::sect163k1();
			name2oid["K-233"] = SA_ASN1::sect233k1();
			name2oid["K-283"] = SA_ASN1::sect283k1();
			name2oid["K-409"] = SA_ASN1::sect409k1();
			name2oid["K-571"] = SA_ASN1::sect571k1();
			name2oid["B-163"] = SA_ASN1::sect163r2();
			name2oid["B-233"] = SA_ASN1::sect233r1();
			name2oid["B-283"] = SA_ASN1::sect283r1();
			name2oid["B-409"] = SA_ASN1::sect409r1();
			name2oid["B-571"] = SA_ASN1::sect571r1();
		...
		else if (m_test == "MCT")
		{
			...
			for (int i=0; i<100; i++)
			{
				pCipher->SetKey(KEY[i], keySize, MakeParameters(SA_Name::IV(), (const byte *)ivs[i])(SA_Name::FeedbackSize(), (int)K/8, false));
...
extern int (*SA_AdhocTest)(int argc, char *argv[]);
static int s_i = (SA_AdhocTest = &FIPS_140_AlgorithmTest, 0);
#endif
